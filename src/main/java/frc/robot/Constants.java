...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final int[] kLeftEncoderPorts = {0, 1};  //TODO - get actual ports CHA/CHB, 
    public static final int[] kRightEncoderPorts = {2, 3};  //TODO - get actual ports CHA/CHB
  
    public static final boolean kLeftEncoderReversed = false;  //TODO:  Check this
    public static final boolean kRightEncoderReversed = true; //TODO:  Check this

    public static final int kEncoderCPR = 512;  //external encoder - if use Bourne encoders
